...
!(function (e, t, n, o, r) {
  ...
  function Bn() {
    return "innerHeight" in Ut
      ? Ut.innerHeight
      : _t.documentElement.offsetHeight;
  }
  function Nn(e, t) {
    var n;
    for (n in ((e = l(e)), t))
  ...
  function Xn(e, t) {
    e = i(e) ? e[0] : e;
    for (
      var n = null != t ? Rn(t, e.parentNode) : e.parentNode.childNodes,
        o = 0,
        r = 0;
      r < n.length;
      r++
  ...
  function Qn(e, t) {
    for (
      "string" == typeof t && (t = ao(t)), e.appendChild(t);
      e.firstChild !== t;
  ...
  function ro(e, t, n) {
    var o;
    (n = void 0 === n ? {} : n),
      "function" == typeof Ut.CustomEvent
  ...
  return (
    ...
    function (e, g) {
      var t =
        ...
        -1 < _t.domain.indexOf("alvarotrigo.com");
      if (!zn(Rn("html"), en)) {
        var r = Rn("html, body"),
          m = Rn("body")[0],
          S = {};
        g = In(
          {
            ...
            scrollOverflowHandler: Ut.fp_scrolloverflow
              ? Ut.fp_scrolloverflow.iscrollHandler
              : null,
          ...
          y &&
            ...
            (S.test = {
              ...
              translate3dH: (function () {
                for (
                  var e = [], t = 0;
                  t < Rn(g.sectionSelector, y).length;
                  t++
                )
            ...
            (function () {
              Nn(y, { height: "100%", position: "relative" }),
                Gn(y, Qt),
                Gn(Rn("html"), en),
                (w = Bn()),
                Fn(y, qt),
              ...
              for (var e = Rn(an), t = 0; t < e.length; t++) {
                ...
                o.setAttribute("data-fp-styles", o.getAttribute("style")),
                  ...
                  g.menu &&
                    g.css3 &&
                    null != Kn(Rn(g.menu)[0], Jt) &&
                    m.appendChild(Rn(g.menu)[0]),
                  0 < i ? me(o, r, i) : g.verticalCentered && bt(o);
              }
              var l, a;
              g.fixedElements &&
                g.css3 &&
                Rn(g.fixedElements).forEach(function (e) {
                  m.appendChild(e);
                }),
                g.navigation &&
                  (function () {
                ...
                Rn('iframe[src*="youtube.com/embed/"]', y).forEach(function (
                  e
                ) {
                  var t, n, o;
                  (n = "enablejsapi=1"),
      ...
      function K(e, t) {
        ...
        if (g.autoScrolling && !g.scrollBar)
          Nn(r, { overflow: "hidden", height: "100%" }),
            $(B.recordHistory, "internal"),
            Nn(y, { "-ms-touch-action": "none", "touch-action": "none" }),
            null != n && Rt(n.offsetTop);
        else if (
          (Nn(r, { overflow: "visible", height: "initial" }),
          $(!!g.autoScrolling && B.recordHistory, "internal"),
          Nn(y, { "-ms-touch-action": "", "touch-action": "" }),
          Bt(y),
          null != n)
        ) {
        ...
        e
          ? ((function () {
              ...
              Ut.addEventListener
                ...
                : ((e = "attachEvent"), (t = "on"));
              var n =
                  "onwheel" in _t.createElement("div")
                    ? "wheel"
                    : void 0 !== _t.onmousewheel
                    ? "mousewheel"
                    : "DOMMouseScroll",
                o = !!R && { passive: !1 };
              "DOMMouseScroll" == n
                ? _t[e](t + "MozMousePixelScroll", Ce, o)
                : _t[e](t + n, Ce, o);
            })(),
            y.addEventListener("mousedown", ot),
            y.addEventListener("mouseup", rt))
          : (_t.addEventListener
              ? (_t.removeEventListener("mousewheel", Ce, !1),
                _t.removeEventListener("wheel", Ce, !1),
                _t.removeEventListener("MozMousePixelScroll", Ce, !1))
              : _t.detachEvent("onmousewheel", Ce),
      ...
      function ne(t, e) {
        void 0 !== e
          ...
          : zt(t, "all", "m"),
          ro(y, "setAllowScrolling", { value: t, directions: e });
      }
      function oe(e) {
        e
          ? (te(!0),
            (function () {
              if (o || i) {
                ...
                e.removeEventListener(k.touchstart, Oe),
                  e.removeEventListener(k.touchmove, Me, { passive: !1 }),
                  e.addEventListener(k.touchstart, Oe),
                  e.addEventListener(k.touchmove, Me, { passive: !1 });
              }
            })())
          : (te(!1),
            (function () {
              if (o || i) {
                g.autoScrolling &&
                  (m.removeEventListener(k.touchmove, Me, { passive: !1 }),
                  m.removeEventListener(k.touchmove, Le, { passive: !1 }));
                var e = g.touchWrapper;
                e.removeEventListener(k.touchstart, Oe),
                  e.removeEventListener(k.touchmove, Me, { passive: !1 });
        ...
        if (!zn(y, qt)) {
          ...
          for (var t = Rn(an), n = 0; n < t.length; ++n) {
            var o = t[n],
              r = Rn(yn, o)[0],
              i = Rn(mn, o);
            g.verticalCentered && Nn(Rn(un, o), { height: yt(o) + "px" }),
              Nn(o, { height: Se(o) + "px" }),
          ...
          l && !Nt("fadingEffect") && ae(l + 1),
            ...
            oo(g.afterResize) &&
              e &&
              g.afterResize.call(y, Ut.innerWidth, Ut.innerHeight),
      ...
      function ve(e) {
        ...
        t && Kn(t, pn + " a")
          ...
          : Kn(t, g.menu + " [data-menuanchor]") &&
            function (e) {
              !Rn(g.menu)[0] ||
                (!g.lockAnchors && g.anchors.length) ||
                (no(e), se(this.getAttribute("data-menuanchor")));
            }.call(t, e);
      }
      function pe(e, t) {
        ...
        (s.className = wn),
          ...
          1 < n &&
            (g.controlArrows &&
              ((l = e),
              (a = [
                ao('<div class="fp-controlArrow fp-prev"></div>'),
                ao('<div class="fp-controlArrow fp-next"></div>'),
              ]),
              $n(Rn(yn, l)[0], a),
            ...
            g.slidesNavigation &&
              (function (e, t) {
                ...
                Nn(n, { "margin-left": "-" + n.innerWidth / 2 + "px" }),
                  Gn(Rn("a", Rn("li", n)[0]), nn);
              })(e, n)),
          t.forEach(function (e) {
            Nn(e, { width: r + "%" }), g.verticalCentered && bt(e);
          });
        var c = Rn(Sn, e)[0];
        null != c &&
        (0 !== Xn(Rn(sn), an) || (0 === Xn(Rn(sn), an) && 0 !== Xn(c)))
          ? (Ht(c, "internal"), Gn(c, "fp-initial"))
          : Gn(t[0], nn);
      }
      function Se(e) {
      ...
      function be(e, t) {
        t || null != Rn(sn)[0] || Gn(e, nn),
          ...
          void 0 !== g.sectionsColor[t] &&
            Nn(e, { "background-color": g.sectionsColor[t] }),
          void 0 !== g.anchors[t] &&
      ...
      function we() {
        ...
        Gn(t, rn),
          ...
          (!(e = Et(et().section)) || (void 0 !== e && Xn(e) === Xn(n))) &&
            oo(g.afterLoad) &&
            Be("afterLoad", {
              activeSection: null,
              element: t,
      ...
      function Ee() {
        ...
        if (
          ...
          if (!zn((e = i[n]), nn)) {
            ...
            p && ((s = p.getAttribute("data-anchor")), (a = Xn(p))),
              x &&
                (Gn(e, nn),
                Fn(to(e), nn),
      ...
      function Me(e) {
        ...
        if (Te(e)) {
          ...
          (G = n.y),
            (F = n.x),
            Rn(yn, t).length && Math.abs(Z - F) > Math.abs(V - G)
              ? !a &&
                Math.abs(Z - F) > (Ut.innerWidth / 100) * g.touchSensitivity &&
                (F < Z ? d.m.right && ce(t) : d.m.left && ue(t))
              : g.autoScrolling &&
                x &&
                Math.abs(V - G) > (Ut.innerHeight / 100) * g.touchSensitivity &&
                (G < V ? Ae("down") : V < G && Ae("up"));
        }
      }
      function Te(e) {
      ...
      function Ie(e) {
        var t = e.offsetHeight,
          ...
          o = n,
          r =
            Nt("dragAndMove") && S.dragAndMove.isGrabbing
          ...
          if (
            ...
            jt("parallax", "apply", i),
              ...
              g.autoScrolling &&
                ...
                ((s = i).isMovementUp
                  ? qn(Rn(sn)[0], co(s.activeSection, an))
                  : $n(Rn(sn)[0], uo(s.activeSection, an).reverse()),
      ...
      function Pe(e) {
        ...
        return (
          g.autoScrolling && !g.scrollBar
            ? ((t.options = -e), (t.element = Rn(Jt)[0]))
            : ((t.options = e), (t.element = Ut)),
          t
        );
      }
      function We(e) {
        ...
        null != (t = e).wrapAroundElements &&
          (t.isMovementUp
            ? qn(Rn(an)[0], t.wrapAroundElements)
            : $n(Rn(an)[Rn(an).length - 1], t.wrapAroundElements),
          Rt(Rn(sn)[0].offsetTop),
          Re(),
      ...
      function Ue(e) {
        var t = (function () {
            if (_t.domain.length) {
              for (
                var e = _t.domain.replace(/^(www\.)/, "").split(".");
                2 < e.length;
        ...
        var c = s ? Fe(P[e]) : "",
          u =
            1 < (c = c.split("_")).length &&
            -1 < c[1].indexOf(e, c[1].length - e.length);
        return (
          (!(c[0].indexOf(t, c[0].length - t.length) < 0 && a && l != c[0]) &&
            u) ||
          !a
        );
      }
      function _e(e) {
        e.forEach(function (e) {
          e.removedNodes[0] &&
            e.removedNodes[0].isEqualNode(Y) &&
            (clearTimeout(D), (D = setTimeout(Qe, 900)));
        });
      }
      function Qe() {
        C = !1;
      ...
      function Je(e) {
        (Y = _t.createElement("div")),
          ...
          (Y.innerHTML = W),
          (Y = Y.firstChild),
          "MutationObserver" in Ut &&
            new MutationObserver(_e).observe(_t.body, {
              childList: !0,
              subtree: !1,
            }),
      ...
      function Ke() {
        Y &&
          (C || (Math.random() < 0.5 ? fo(m, Y) : Un(Y, m), (C = !0)),
          Y.setAttribute(
            "style",
            // mojahed
            Fe(
      ...
      function tt(e) {
        ...
        9 === n
          ...
          : io(t, "textarea") ||
            ...
            !g.keyboardScrolling ||
            !g.autoScrolling ||
            (-1 < [40, 38, 32, 33, 34].indexOf(n) && no(e),
            (c = e.ctrlKey),
      ...
      function st(e, t, n) {
        ...
        (r.xMovement = St(r.prevSlideIndex, r.slideIndex)),
          ...
          !1 === Be("onSlideLeave", r)
            ...
            : (Gn(t, nn),
              Fn(to(t), nn),
              r.localIsResizing || (Ze(r.prevSlide), De(t)),
              ct(r),
              zn(o, nn) &&
                !r.localIsResizing &&
                Lt(r.slideIndex, r.slideAnchor, r.anchorLink, r.sectionIndex),
              S.continuousHorizontal && S.continuousHorizontal.apply(r),
              Wt() ? ut(r) : dt(e, r, !0),
              g.interlockedSlides &&
                S.interlockedSlides &&
                ((Nt("continuousHorizontal") &&
                  void 0 !== n &&
                  n !== r.xMovement) ||
      ...
      function ct(e) {
        !g.loopHorizontal &&
          g.controlArrows &&
          (lo(Rn(kn, e.section), 0 !== e.slideIndex),
      ...
      function ut(e) {
        ...
        S.continuousHorizontal && S.continuousHorizontal.afterSlideLoads(e),
          ...
          g.slidesNavigation &&
            null != t &&
            (Fn(Rn(on, t), nn), Gn(Rn("a", Rn("li", t)[n]), nn)),
          e.localIsResizing ||
      ...
      function pt(e) {
        ...
        return Fn(e, $t), Nn(e, { "-webkit-transition": t, transition: t });
      }
      function ht(e) {
        return Gn(e, $t);
      }
      function gt(e, t) {
        ...
        (n = e),
          ...
          g.menu &&
            null != o &&
            (Fn(Rn(on, o), nn), Gn(Rn('[data-menuanchor="' + n + '"]', o), nn)),
          (r = e),
          (i = t),
          (l = Rn(pn)[0]),
          g.navigation &&
      ...
      function xt(e, t) {
        ...
        if (null != n) {
          var o,
            ...
            l =
              (null ==
                (i = Rn(mn + '[data-anchor="' + (o = t) + '"]', (r = n))[0]) &&
                ((o = void 0 !== o ? o : 0), (i = Rn(mn, r)[o])),
              i);
          Tt(n) === b || zn(n, nn)
            ? At(l)
            : ze(n, function () {
      ...
      function zt(t, e, n) {
        "all" !== e
          ? (d[n][e] = t)
          : Object.keys(d[n]).forEach(function (e) {
              d[n][e] = t;
            });
      }
      function Bt(e) {
        return Nn(e, { "-webkit-transition": "none", transition: "none" });
      }
      function Nt(e) {
        return null !== g[e] &&
      ...
      function Vt(e, t) {
        !g.autoScrolling || g.scrollBar || (e.self != Ut && zn(e, bn))
          ? e.self != Ut && zn(e, bn)
            ? (e.scrollLeft = t)
            : e.scrollTo(0, t)
          : (e.style.top = t + "px");
